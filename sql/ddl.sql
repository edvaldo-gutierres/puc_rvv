...
(
	...
	CONSTRAINT PK_Departamento PRIMARY KEY (Codigo_do_Departamento)
);
...
(
	...
	CONSTRAINT PK_Cargo PRIMARY KEY (Codigo_do_Cargo)
);
...
(
    ...
    Sexo VARCHAR(1) NOT NULL CONSTRAINT Sexo CHECK(Sexo IN ('F','M')),
	...
	CONSTRAINT PK_Colaborador PRIMARY KEY (Matricula_do_Colaborador)
);
